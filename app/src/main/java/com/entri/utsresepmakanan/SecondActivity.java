...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("masakaninter");
    ...
    public void detail(View view) {
        ...
        switch (position) {
            case 0 :
                ...
                break;
            case 1 :
                Intent intent1 = new Intent(this, PizzaActivity.class);
                startActivity(intent1);
                break;
            case 2 :
                Intent intent2 = new Intent(this, RamenActivity.class);
                startActivity(intent2);
                break;
            case 3 :
                Intent intent3 = new Intent(this, SteakActivity.class);
                startActivity(intent3);
                break;
            case 4 :
                Intent intent4 = new Intent(this, SushiActivity.class);
