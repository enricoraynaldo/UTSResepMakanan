...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public  RecyclerViewAdapter(List<ImageUploadInfo> MainimageUploadInfoList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.listview_kategori, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Glide.with(context).asBitmap().load(data.getImageUrl()).fitCenter().into(holder.imageView);
